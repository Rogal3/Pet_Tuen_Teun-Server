...
public class CommentManager {
	...
	public CommentManager() {
		...
		cmt.add(new Comment("aaa","せせせせせ","19/10/30"));
		cmt.add(new Comment("ccc","せせせせせ","19/10/30"));
		cmt.add(new Comment("ddd","せせせせせ","19/10/30"));
		cmt.add(new Comment("bbb","せせせせせ","19/10/30"));
